  ...
  try {
    ...
    await pool.query(`
      CREATE TABLE IF NOT EXISTS messageAttachment (
        ...
        FOREIGN KEY (Message_ID) REFERENCES Message(Message_ID) ON DELETE CASCED,
    ...
    await pool.query(`
      CREATE TABLE IF NOT EXISTS submissionAttachment (
        ...
        FOREIGN KEY (Attachment_ID) REFERENCES Attachment(Attachment_ID) ON DELETE SET CASCADE,
