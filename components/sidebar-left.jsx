...
import {Armchair, BookOpen, Frame, Handshake, Laptop2, LifeBuoy, Map, PieChart, Send, User,} from "lucide-react"
import {NavMain} from "@/components/nav-main"
import {NavChat} from "@/components/nav-projects"
...
export function SidebarLeft({...props}) {
    ...
    return (<Sidebar variant="inset" {...props}>
                    ...
                    <SidebarMenuButton size="lg" asChild>
                        <Link href="#">
                            ...
                            <div className="grid flex-1 text-left text-sm leading-tight">
                                <span className="truncate font-semibold">Cairo University</span>
        ...
        <SidebarFooter>
            ...
            {isLoaded ? <SignedIn>
                <NavUser
                    email={user?.emailAddresses[0]?.emailAddress} avatar={user?.imageUrl}
                    name={user?.fullName} />
