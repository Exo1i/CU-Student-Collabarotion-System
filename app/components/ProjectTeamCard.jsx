...
import { CheckCircle, ChevronDown, ChevronUp, Crown, XCircle , UserCheck } from 'lucide-react'
...
export default function ProjectTeamCard({ userid ,  Team, projectID , userTeamNumber }) {
    ...
    const isUserInThisTeam = userTeamNumber === Team.team_num;
    const isUserInAnyTeam = userTeamNumber !== null;
    console.log("current user team number : " + userTeamNumber)
    return (
