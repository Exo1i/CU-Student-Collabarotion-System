...
export default function InstructorPage({params}) {
    ...
    const [currentProject, setCurrentProject] = useState({
        name: "", description: "", teamSize: 0, grade: 0, dueDate: "",
    });
        ...
        async function fetchCourseData() {
            try {
                ...
                setAssignments(data.course.assignments.map((assignment) => ({
                    ...assignment, course_code: data.course.course_code,
                })));
    ...
    return (<div className="container mx-auto p-4 min-h-screen">
            ...
            <div className="grid gap-8">
                        ...
                        >
                            <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
                                ...
                                <CardContent className="flex flex-col gap-5">
                                    <EnrolledStudents />
                                    {Object.keys(currentProject).length === 0 && (<CreateProject
                ...
                <motion.div
                    ...
                    transition={{duration: 0.5, delay: 0.2}}
                >
                    {Object.keys(currentProject).length !== 0 && (<CurrentProject
