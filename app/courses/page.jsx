    ...
    <div className="container mx-auto py-12 px-4">
      ...
      >
        {filterdCourses.map((course) => (
          ...
          >
            <Card className="group overflow-hidden bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 ease-in-out transform hover:-translate-y-2">
